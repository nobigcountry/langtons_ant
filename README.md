...
[Langton's Ant](https://en.wikipedia.org/wiki/Langton%27s_ant) is a cellular automata and a two-dimensional Turing machine. This project is a simple implementation using the SDL2 library.
